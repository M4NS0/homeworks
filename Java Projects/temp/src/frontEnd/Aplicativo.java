		...
		btnExportarParaO.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String nomeBanco = nomeArquivo.substring(0, nomeArquivo.lastIndexOf("."))
					...
					Dao.criandoTabelas(nomeBanco, nomeArquivo.substring(0, nomeArquivo.lastIndexOf(".")),
							tableModel);
					construtorDoArquivo = new ConstrutorParaOArquivo(arrayList, tableModel.getColumnCount());
