...
public class ConvertPDFPagesToImages {
    public static void main(String[] args) {
        try {
            String sourceDir = "/home/linuxlite/Downloads/PROCURAÇÃO LABORTECH.pdf"; // Pdf files are read from this folder
            String destinationDir = "/home/linuxlite/Downloads/"; // converted images from pdf document are saved here
