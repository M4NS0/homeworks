...
public class FrmContatosLista extends JFrame {
	...
	public FrmContatosLista() {
		...
		lblNewLabel.setFont(new Font("Ubuntu Mono", Font.PLAIN, 13));
		...
		btnInserir.setFont(new Font("Ubuntu Mono", Font.PLAIN, 11));
		...
		btnAlterar.setFont(new Font("Ubuntu Mono", Font.PLAIN, 11));
		...
		btnExcluir.setFont(new Font("Ubuntu Mono", Font.PLAIN, 11));
		...
		btnSair.setFont(new Font("Ubuntu Mono", Font.PLAIN, 11));
