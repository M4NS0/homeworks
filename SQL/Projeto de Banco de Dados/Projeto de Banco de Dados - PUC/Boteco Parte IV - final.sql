...
CREATE TABLE "INGREDIENTE-ITEM-CARDAPIO" (
	...
	CONSTRAINT "Fk-Numero-ingrediente" FOREIGN KEY ("numero-ingrediente") REFERENCES public."INGREDIENTE" ("Numero-ingrediente"),
	CONSTRAINT "Fk-Numero-item-cardapio" FOREIGN KEY ("numero-item-cardapio") REFERENCES public."ITEM-CARDAPIO" ("Numero-item-cardapio")
);
...
CREATE TABLE public."PEDIDO" (
	...
	"cpf-cliente" int,
	"cpf-entregador" int,
	"numero-mesa-atual" character varying (4),
	"numero-mesa-anterior" character varying (4),
	"numero-lugares" int,
	CONSTRAINT "Pkey-pedido" PRIMARY KEY ("Numero-pedido"),
	CONSTRAINT "Fkey-cliente" FOREIGN KEY ("cpf-cliente") REFERENCES public."CLIENTE-EXTERNO" ("Cpf-cliente"),
	CONSTRAINT "Fkey-garcom" FOREIGN KEY ("cpf-garcom", "nome-garcom") REFERENCES public."GARCOM" ("Cpf-garcom", "Nome-garcom"),
	CONSTRAINT "Fkey-gerente" FOREIGN KEY ("cpf-gerente", "nome-gerente") REFERENCES public."GERENTE" ("cpf-gerente", "nome-gerente"),
	CONSTRAINT "Fkey-entregador" FOREIGN KEY ("cpf-entregador") REFERENCES public."ENTREGADOR" ("Cpf-entregador"),
	CONSTRAINT "Fkey-mesa" FOREIGN KEY ("numero-mesa-atual", "numero-lugares") REFERENCES public."MESA" ("Numero-mesa", "Numero-lugares"),
	CONSTRAINT "Fkey-mesa2" FOREIGN KEY ("numero-mesa-anterior", "numero-lugares") REFERENCES public."MESA" ("Numero-mesa", "Numero-lugares")
);
...
CREATE TABLE public."ITEM-CARDAPIO-PEDIDO" (
	...
	CONSTRAINT "Fkey-pedido" FOREIGN KEY ("Numero-pedido") REFERENCES public."PEDIDO" ("Numero-pedido"),
	CONSTRAINT "Fkey-cozinheiro" FOREIGN KEY ("Cpf-cozinheiro") REFERENCES public."COZINHEIRO" ("Cpf-cozinheiro"),
	CONSTRAINT "Fkey-item-cardapio" FOREIGN KEY ("Numero-item-cardapio") REFERENCES public."ITEM-CARDAPIO" ("Numero-item-cardapio")
);
...
CREATE TABLE public."INGREDIENTE-ITEM-PEDIDO" (
	...
	"Numero-ingrediente" bigint NOT NULL,
	CONSTRAINT "Pk-ingrediente-item-pedido" PRIMARY KEY (
		"Numero-pedido",
		"Numero-item-cardapio",
		"Numero-ingrediente"
	),
	CONSTRAINT "Fk-ingrediente-item-cardapio" FOREIGN KEY ("Numero-ingrediente", "Numero-item-cardapio") REFERENCES "INGREDIENTE-ITEM-CARDAPIO" ("numero-ingrediente", "numero-item-cardapio"),
	CONSTRAINT "Fk-item-cardapio-pedido" FOREIGN KEY ("Numero-item-cardapio", "Numero-pedido") REFERENCES public."ITEM-CARDAPIO-PEDIDO" ("Numero-item-cardapio", "Numero-pedido")
);
...
INSERT INTO
	"GERENTE"
VALUES
	('Gerente1', 10001, 1200.00, 9910001, 'V', 'H'),
...
INSERT INTO
	"COZINHEIRO"
VALUES
	('Cozinheiro1', 10061, 1400.00, 9910061, 'V', 'H'),
...
INSERT INTO
	"ENTREGADOR"
VALUES
	('Entregador1', 10101, 800.00, 9919061, 'V', 'H'),
...
INSERT INTO
	"CLIENTE-EXTERNO"
VALUES
	('Cliente1', 11101, 'Rua A', 22519061, 9901001),
...
UPDATE
	"GERENTE"
SET
	"salario-gerente" = "salario-gerente" + ("salario-gerente" * 5 / 100)
WHERE
	"turno-gerente" = 'N'
	AND "sexo-gerente" = 'M';
...
---------------------------------------------------------------------------------------------------
SELECT
	"nome-gerente" AS "Nome do Gerente",
...
SET
	"sexo-gerente" = 'M'
WHERE
	"nome-gerente" = 'Gerente2'
	OR "nome-gerente" = 'Gerente1';
...
WHERE
	"Turno-garcom" = 'N'
	AND "Salario-garcom" > 1399.00;

---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
SELECT
	"Nome-garcom" AS "Nome do Garçom",
...
UPDATE
	"GARCOM"
SET
	"Salario-garcom" = "Salario-garcom" + ("Salario-garcom" * 6 / 100)
WHERE
	"Turno-garcom" = 'N'
	AND "Sexo-garcom" = 'M';
...
SET
	...
	"Turno-entregador" = 'N'
WHERE
	"Nome-entregador" = 'Entregador1';

---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
SELECT
	"Nome-entregador" AS "Entregador",
...
UPDATE
	"ENTREGADOR"
SET
	"Salario-entregador" = "Salario-entregador" + ("Salario-entregador" * 15 / 100)
WHERE
	"Turno-entregador" = 'N';
...
UPDATE
	"CLIENTE-EXTERNO"
SET
	"Endereço" = CONCAT("Endereço", ' - Número 100')
WHERE
	"Endereço" = 'Rua A';
...
---------------------------------------------------------------------------------------------------
SELECT
	"Nome-cliente" AS "Nome do Cliente",
	"Endereço" AS "Endereço Atualizado"
FROM
	"CLIENTE-EXTERNO"
WHERE
	"Nome-cliente" = 'Cliente1'
	OR "Nome-cliente" = 'Cliente27';
...
UPDATE
	"COZINHEIRO"
SET
	"Nome-cozinheiro" = 'João Paulo'
WHERE
	"Nome-cozinheiro" = 'Cozinheiro1';

---------------------------------------------------------------------------------------------------
UPDATE
	"COZINHEIRO"
SET
	"Salario-cozinheiro" = "Salario-cozinheiro" - ("Salario-cozinheiro" * 20 / 100)
WHERE
	"Turno-cozinheiro" = 'V';
...
UPDATE
	"ITEM-CARDAPIO"
SET
	"Valor-item" = "Valor-item" - ("Valor-item" * 0.05)
WHERE
	(
		"Numero-item-cardapio" BETWEEN 5
		AND 7
	)
	OR (
		"Numero-item-cardapio" BETWEEN 15
		AND 17
	);
...
---------------------------------------------------------------------------------------------------
SELECT
	"Numero-item-cardapio" AS "Item do cardápio",
	"Descricao",
	"Valor-item" AS "Preço"
FROM
	"ITEM-CARDAPIO"
...
UPDATE
	"INGREDIENTE"
SET
	"Descricao" = CONCAT('Peixe')
WHERE
	"Numero-ingrediente" = 1;

---------------------------------------------------------------------------------------------------
UPDATE
	"INGREDIENTE"
SET
	"Descricao" = CONCAT("Descricao", ' - indisponível')
WHERE
	"Numero-ingrediente" BETWEEN 2
	AND 4;
...
UPDATE
	"INGREDIENTE"
SET
	"Descricao" = CONCAT("Descricao", ' - disponível')
WHERE
	"Numero-ingrediente" > 4;
...
UPDATE
	"INGREDIENTE-ITEM-CARDAPIO"
SET
	"Valor-ingrediente" = "Valor-ingrediente" + ("Valor-ingrediente" * 0.05)
WHERE
...
UPDATE
	"INGREDIENTE-ITEM-CARDAPIO"
SET
	"Quantidade-ingrediente" = 100
WHERE
	"Quantidade-ingrediente" >= 80;

---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
SELECT
	"numero-ingrediente" AS "Número do Ingrediente",
	"Quantidade-ingrediente" AS "Quantidade em Gramas",
	"Valor-ingrediente" AS "Valor por Grama",
	("Quantidade-ingrediente") * ("Valor-ingrediente") AS "Total em Reais"
FROM
...
WHERE
	"numero-mesa-atual" = '1'
	OR "numero-mesa-atual" = '2'
	OR "numero-mesa-atual" = '3'
	OR "numero-mesa-atual" = '4'
	OR "numero-mesa-atual" = '5'
	OR "numero-mesa-atual" = '6'
	OR "numero-mesa-atual" = '7'
	OR "numero-mesa-atual" = '8'
	OR "numero-mesa-atual" = '9'
	OR "numero-mesa-atual" = '10';

---------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------
SELECT
	"Numero-pedido" AS "Numero do Pedido",
	"numero-mesa-atual" AS "Mesas em Sistema de Cupom",
...
---------------------------------------------------------------------------------------------------
SELECT
	"Numero-pedido" AS "Pedido",
	"numero-mesa-atual" AS "Mesa",
	"nome-garcom" AS "Atendente",
	"cpf-garcom" AS "CPF"
FROM
	"PEDIDO"
WHERE
	"nome-garcom" IS NOT NULL
	AND "Numero-pedido" >= 12
ORDER BY
	"Numero-pedido";
...
FROM
	"ITEM-CARDAPIO-PEDIDO"
WHERE
	"Cpf-cozinheiro" = 10061
ORDER BY
	"Numero-item-cardapio" DESC;
...
UPDATE
	"INGREDIENTE-ITEM-PEDIDO"
SET
	"Quantidade-item-pedido" = "Quantidade-item-pedido" + 3
WHERE
	"Quantidade-item-pedido" <= 10;
...
UPDATE
	"INGREDIENTE-ITEM-PEDIDO"
SET
	"Quantidade-item-pedido" = "Quantidade-item-pedido" - 0.5
WHERE
	"Quantidade-item-pedido" <= 10;
...
/* PARTE 4 */
--------------------------------------------------------------------------------
-- Quais pedidos tiveram a quantidade de ingrediente alterado pelo cliente    --
-- Apresentar (Num pedido, Data do pedido, nome-ingrediente, Qtde ingrediente --
-- original (que está no cardápio), Nova qtde (pedida pelo cliente));         --
--------------------------------------------------------------------------------
CREATE VIEW "Pedidos alterados pelos clientes" ("Número", "Ingrediente") AS (
	SELECT
		ip."Numero-pedido",
		i."Descricao"
	FROM
		"INGREDIENTE-ITEM-PEDIDO" ip,
		"INGREDIENTE-ITEM-CARDAPIO" ic,
		"INGREDIENTE" i
	WHERE
		ip."Numero-item-cardapio" = ic."numero-item-cardapio"
		AND ip."Numero-ingrediente" = ic."numero-ingrediente"
		AND ip."Quantidade-item-pedido" != ic."Quantidade-ingrediente"
		AND i."Numero-ingrediente" = ic."numero-ingrediente"
);

SELECT
	p."Numero-pedido" AS "Numero do pedido",
	p."Data-pedido" AS "Data do pedido",
	n."Ingrediente" AS "Nome do ingrediente",
	ip."Quantidade-item-pedido" AS "Quantidade de Ingredientes",
	ic."Quantidade-ingrediente" AS "Alteração de Pedido"
FROM
	"PEDIDO" p,
	"Pedidos alterados pelos clientes" n,
	"INGREDIENTE-ITEM-PEDIDO" ip,
	"INGREDIENTE-ITEM-CARDAPIO" ic
WHERE
	n."Número" = p."Numero-pedido"
	AND ip."Numero-pedido" = p."Numero-pedido"
	AND ic."numero-ingrediente" = ip."Numero-ingrediente"
	AND ic."numero-item-cardapio" = ip."Numero-item-cardapio";

--DROP VIEW "Pedidos alterados pelos clientes";
-----------------------------------------------------------------------
-- Quantos pedidos tiveram troca de mesa no mês de abril. Apresentar --
-- ( Quantidade de pedidos com troca de mesa,  no mês de abril );    --
-----------------------------------------------------------------------
SELECT
	COUNT("Numero-pedido") AS "Quantidade de trocas de mesa em abril"
FROM
	"PEDIDO" p
WHERE
	(
		p."numero-mesa-anterior" != 'null'
		AND p."numero-mesa-atual" != 'null'
	)
	AND "Data-pedido" BETWEEN '01/04/2020'
	AND '30/04/2020';

------------------------------------------------------------------------------------------------
-- Qual percentual de pedidos feitos por delivery no período de 16/03/2020 até a data de hoje --
-- Apresentar ( Qtde pedidos total,  qtde-pedidos delivery,   Percentual de delivery).        --
------------------------------------------------------------------------------------------------
CREATE VIEW "Quantidade de Pedidos feitos por Clientes Externos" ("Delivery") AS (
	SELECT
		COUNT(*)
	FROM
		"PEDIDO" p
	WHERE
		p."cpf-entregador" > 0
		and "Data-pedido" between '16/03/2020'
		and current_date
);

CREATE VIEW "Total de Pedidos" ("Total") AS (
	SELECT
		COUNT(*)
	FROM
		"PEDIDO"
	WHERE
		"Data-pedido" between '16/03/2020'
		and current_date
);

SELECT
	"Total" AS "Quantidade pedidos total",
	"Delivery" AS "Quantidade pedidos delivey",
	("Delivery" * 100) / "Total" AS "Percentual de delivery"
FROM
	"Quantidade de Pedidos feitos por Clientes Externos",
	"Total de Pedidos";

--DROP VIEW "Quantidade de Pedidos feitos por Clientes Externos";
--DROP VIEW "Total de Pedidos";
--------------------------------------------------------------------------------
-- Quantos pedidos atendidos pelo cozinheiro ‘João Paulo’ e que tenha ‘Peixe’ --
-- como ingrediente Apresentar (“Cozinheiro ->João Paulo”, Qtde-pedidos).     --
--------------------------------------------------------------------------------
SELECT
	c."Nome-cozinheiro" as "Cozinheiro",
	ig."Descricao" as "Descrição do Ingrediente",
	count(ip."Numero-pedido") as "Quantidade de pedidos"
FROM
	"ITEM-CARDAPIO-PEDIDO" ip,
	"COZINHEIRO" c,
	"INGREDIENTE-ITEM-CARDAPIO" ic,
	"INGREDIENTE" ig
WHERE
	ip."Cpf-cozinheiro" = c."Cpf-cozinheiro"
	AND ip."Numero-item-cardapio" = ic."numero-item-cardapio"
	AND ig."Numero-ingrediente" = ic."numero-ingrediente"
	AND ig."Descricao" = 'Peixe'
	AND c."Nome-cozinheiro" = 'João Paulo'
GROUP BY
	1,
	2;