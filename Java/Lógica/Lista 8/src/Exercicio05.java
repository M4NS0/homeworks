...
public class Exercicio05 {
	public static void main(String args[]) {
		...
		// Para uma loja, ideal que esse numero seja definido pelo proprio usuario
		// devido
		// a variacao de vendas ao dia.
		// MAS o problema pede 25 transações e, para teste, modifica-se o MAX para um
		// numero minimo
		final int MAX = 25;
		...
		// laço:
		// é utilizado quando precisa cadastrar muitas coisas pra depois gerar um
		// relatorio
		// ja que o problema define um incio e um fim, pode utilizar o FOR invez de
		// WHILE
		// assim que alcançar 25 ele vai parar de cadastrar
		// cadastro inicia com 1 e repete 25 vezes (definido em MAX)
		// PARA cadastro iniciando em 1; roda até 25 vezes cadastro é igual ao cadastro
		// anterior mais um cadastro (contador)
		...
		// firulas cosmeticas
		System.out.println(" __________________________________" + "\n| sub Total em DINHEIRO: " + somaDinheiro
