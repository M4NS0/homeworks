...
import br.com.hiccupSolucoes.cadastro.persistencia.cargoDao;
...
public class Test {
	public static void main(String[] args) {
		...
		Cargo estagio = new Cargo();
		estagio.setnomeCargo("Estagiário");
		// no Mysql será feito um insert into table.cargo (nomeCargo)
		cargoDao.adicionaCargo(estagio);
		...
		departamento.setNomeCargo(estagio);
