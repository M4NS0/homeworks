...
public class ServletCadastroFuncionario extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Funcionario funcionarioAtual = new Funcionario(nome, dataDeNascimento, email, cnh, cargo);
		SalvarCsv salvar = new SalvarCsv();

		if (cargo.equalsIgnoreCase("Professor")) {
			salvar.adcionarProfessorAoCsv(funcionarioAtual);
		} else {
			salvar.adcionarFuncionarioAoCsv(funcionarioAtual);
		}

		/*
		 * JOptionPane.showMessageDialog(null, "\n\tNome: " + nome +
		 * "\n\tData de nascimento: " + dataDeNascimento + "\n\tEmail: " + email +
		 * "\n\tCNH: " + cnh + "\nCargo: " + cargo, "Cadastrado com Sucesso!",
