...
public class DetailsDatabase extends SQLiteOpenHelper {
    ...
    public DetailsDatabase(@Nullable Context context) {
    ...
    public void addCoin(Details details) {
    ...
    public Details selectDetails(int i) {
        ...
        Details coinDetails = new Details(
                cursor.getInt(0),
                cursor.getString(1),
                cursor.getString(2),
                cursor.getString(3),
    ...
    public List<Details> listTransactions() {
        SQLiteDatabase db = this.getReadableDatabase();
        List<Details> transactionList = new ArrayList<>();
